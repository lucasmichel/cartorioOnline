...
<head>
    ...
    <script type="text/javascript" src="<?php echo $strDir;?>/js/frmTipoPatrimonio.js"></script>    
</head>
<body>    
    <div id="tabs">
        <ul>
            <li><a href="#tabs-1">Grupos de Bens Cadastrados</a></li>
        ...
        <div id="tabs-2">
            ...
            <form id="frmCadastro" name="frmFormulario" action="<?php echo $strDir;?>/controladores/TipoPatrimonioControlador.php" method="POST">
                ...
                <fieldset class="linha">
                    ...
                    <input type="text" id="txtDescricao" name="TIP_Descricao" class="campoTextoPadrao" style="width: 400px" placeholder="DESCRIÇÃO TIPO DE PATRIMÔNIO" />
                </fieldset>
                <fieldset class="linha" style="margin-top: 10px;">
                    <input type="checkbox" id="ckbStatus" name="TIP_Status" value="I" />Inativo<br />
                </fieldset>
                <fieldset class="linha" style="margin-top: 10px;">
