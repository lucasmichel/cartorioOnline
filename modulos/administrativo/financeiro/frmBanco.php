...
<head>
    ...
    <script type="text/javascript" src="<?php echo $strDir; ?>/js/frmBanco.js"></script>    
</head>
<body>    
    <div id="tabs">
        <ul>
            <li><a href="#tabs-1">Bancos Cadastrados</a></li>
            ...
            <div>
                <form id="frmPesquisa" onSubmit="return false;">  
                    <fieldset class="coluna">
                        <label for="txtPesquisaDescricao">Banco</label>
        ...
        <div id="tabs-2">
            ...
            <form id="frmCadastro" action="<?php echo $strDir;?>/controladores/BancoControlador.php" method="POST" onSubmit="return false;">
                ...
                <fieldset class="coluna">
                    <label for="txtDescricao">Nome do Banco*</label>
                    <input type="text" id="txtDescricao" name="BAN_Descricao" class="campoTextoPadrao" style="width: 250px;" placeholder="NOME DO BANCO." />
                </fieldset>
                <fieldset class="coluna">
                    <label for="txtCodigo">C&oacute;digo</label>
                    <input type="text" id="txtCodigo" name="BAN_Codigo" class="campoTextoPadrao" placeholder="C&Oacute;DIGO DO BANCO." />
                </fieldset>
                <fieldset class="linha">
                    <input type="checkbox" id="ckbStatus" name="BAN_Status"  value="I" />Inativo<br />
                </fieldset>
                <fieldset class="linha">
