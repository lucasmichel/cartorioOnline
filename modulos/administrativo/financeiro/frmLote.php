...
<head>
    ...
    <script type="text/javascript" src="<?php echo $strDir; ?>/js/frmLote.js"></script>    
</head>
<body>    
    <div id="tabs">
        <ul>
            <li><a href="#tabs-1">Lotes Cadastrados</a></li>
            ...
            <div>
                <form id="frmPesquisa" onSubmit="return false;">  
                    <fieldset class="coluna">
                        <label for="txtPesquisaDescricao">Lote</label>
        ...
        <div id="tabs-2">
            ...
            <form id="frmCadastro" action="<?php echo $strDir;?>/controladores/LoteControlador.php" method="POST" onSubmit="return false;">
                ...
                <input type="hidden" id="hddID" name="LOT_ID"/><!-- PK do registro, utilizado no ALTERAR -->
                <input type="hidden" id="hddFocus"/><!-- responsável por guardar o campos que receberá o focus -->                
                <fieldset class="coluna">
                    <label for="txtDescricao">Nome do Lote*</label>
                    <input type="text" id="txtDescricao" name="LOT_Descricao" class="campoTextoPadrao" style="width: 250px;" placeholder="NOME DO LOTE." />
                </fieldset>                
