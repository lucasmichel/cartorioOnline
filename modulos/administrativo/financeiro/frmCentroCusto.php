...
<head>
    ...
    <script type="text/javascript" src="<?php echo $strDir; ?>/js/frmCentroCusto.js"></script> 
</head>

<body>    
    <div id="tabs">
        <ul>
            <li><a href="#tabs-1">Centros de Custo Cadastrados</a></li>
            ...
            <div>
                <form id="frmPesquisa" class="frmPesquisa">
                    <fieldset class="coluna">
                        <label for="txtPesquisaDescricao">Centro de Custo</label>
        ...
        <div id="tabs-2">
            ...
            <form id="frmCadastro" name="frmCadastro" action="<?php echo $strDir;?>/controladores/CentroCustoControlador.php" method="POST" onSubmit="return false;">
                ...
                <input type="hidden" id="hddID" name="CEN_ID"/><!-- PK do registro, utilizado no ALTERAR -->
                <input type="hidden" id="hddFocus"/>  
                <fieldset class="linha">
                    <label for="txtDescricao">Descri&ccedil;&atilde;o*</label>
                    <input type="text" id="txtDescricao" name="CEN_Descricao" class="campoTextoPadrao" placeholder="INFORME A DESCRIÇÃO DO CENTRO DE CUSTO." style="width: 300px;"/>                
                </fieldset>
                <fieldset class="linha">
                    
                    <label>Anotações</label>                        
                        <textarea id="txtAnotacao" name="CEN_Observacao" rows="4" class="campoTextoPadrao" placeholder="" style="width: 98%"></textarea>                                
                    
                </fieldset>
                <fieldset class="linha">
                    <input type="checkbox" id="ckbStatus" name="CEN_Status" value="I" class="status"/>Inativo
                </fieldset>                
                <fieldset class="linha">
