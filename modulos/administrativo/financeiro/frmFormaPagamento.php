...
<head>
    ...
    <script type="text/javascript" src="<?php echo $strDir; ?>/js/frmFormaPagamento.js"></script> 
</head>

<body>    
    <div id="tabs">
        <ul>
            <li><a href="#tabs-1">Formas de Pagamentos Cadastradas</a></li>
            ...
            <div>
                <form id="frmPesquisa" class="frmPesquisa">
                    <fieldset class="coluna">
                        <label for="txtPesquisaDescricao">Forma de Pagamento</label>
        ...
        <div id="tabs-2">
            ...
            <form id="frmCadastro" name="frmCadastro" action="<?php echo $strDir;?>/controladores/FormaPagamentoControlador.php" method="POST" onSubmit="return false;">
                ...
                <input type="hidden" id="hddID" name="FPG_ID"/><!-- PK do registro, utilizado no ALTERAR -->
                <input type="hidden" id="hddFocus"/>  
                <fieldset class="linha">
                    <label for="txtDescricao">Descri&ccedil;&atilde;o*</label>
                    <input type="text" id="txtDescricao" name="FPG_Descricao" class="campoTextoPadrao" placeholder="INFORME A DESCRI&Ccedil;&Atilde;O DA FORMA DE PAGAMENTO." style="width: 300px;"/>                
                </fieldset>  
                <fieldset class="linha">
                    <input type="checkbox" id="ckbExigeNumero" name="FPG_ExigeNumero" value="S" class="status"/>Exige o Número do Documento
                </fieldset> 
                <fieldset class="linha">
                    <input type="checkbox" id="ckbStatus" name="FPG_Status" value="I" class="status"/>Inativo
                </fieldset>                
                <fieldset class="linha">
