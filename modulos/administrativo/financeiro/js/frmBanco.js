...
var controlador  = "../../administrativo/financeiro/controladores/BancoControlador.php";
var dg           = $('#grid');
...
function initGRID(){ 
    ...
    dg.datagrid({
                        ...
                        $.post(controlador, {
                            ...
                            function(data){                                
                                if(data.sucesso == "true"){                                    
                                    $("#txtDescricao").val(data.rows[0].BAN_Descricao);
                                    $("#txtCodigo").val(data.rows[0].BAN_Codigo);
                                    
                                    if(data.rows[0].BAN_Status == "I"){ 
        ...
        ,mapper:[{
            name: 'BAN_ID', title: 'Cód.', width: 60, align: 'left'
        },{
            name: 'BAN_Descricao', title: 'Descrição', width: 680, align: 'left'
        },{
            name: 'BAN_Codigo', title: 'Código', width: 200, align: 'left'
        },{
            name: 'BAN_Status', title: 'Ativo', width: 60, align: 'center', render: function(d) {
                var status = 'SIM';
...
function salvar(){
    ...
    if($.trim($('#txtDescricao').val()) == ""){        
        ...
        $("#dialog-atencao").html("Por favor, informe o nome do banco.");
        $("#dialog-atencao").dialog("open");
        return;
    }
