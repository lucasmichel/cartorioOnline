...
<head>
    ...
    <script type="text/javascript" src="<?php echo $strDir; ?>/js/frmAtividade.js"></script>    
</head>
<body>    
    <div id="tabs">
        <ul>
            <li><a href="#tabs-1">Atividades Cadastradas</a></li>
            ...
            <div>
                <form id="frmPesquisa" onSubmit="return false;">  
                    <fieldset class="coluna">
                        <label for="txtPesquisaDescricao">Atividade</label>
        ...
        <div id="tabs-2">
            ...
            <form id="frmCadastro" action="<?php echo $strDir;?>/controladores/AtividadeControlador.php" method="POST" onSubmit="return false;">
                ...
                <fieldset class="coluna">
                    <label for="txtDescricao">Nome da Atividade*</label>
                    <input type="text" id="txtDescricao" name="ATV_Descricao" class="campoTextoPadrao" style="width: 250px;" placeholder="NOME DA ATIVIDADE." />
                </fieldset>                
                <fieldset class="linha">
                    <input type="checkbox" id="ckbExigeData" name="ATV_ExigeData" value="S" />Exige Data?<br />
                </fieldset>
                <fieldset class="linha">
                    <input type="checkbox" id="ckbStatus" name="ATV_Status" value="I" />Inativo<br />
                </fieldset>
                <fieldset class="linha">
