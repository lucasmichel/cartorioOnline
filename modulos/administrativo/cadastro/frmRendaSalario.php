...
<head>
    ...
    <script type="text/javascript" src="<?php echo $strDir; ?>/js/frmRendaSalario.js"></script>    
</head>
<body>    
    <div id="tabs">
        <ul>
            <li><a href="#tabs-1">Rendas Salariais Cadastradas</a></li>
            ...
            <div>
                <form id="frmPesquisa" onSubmit="return false;">  
                    <fieldset class="coluna">
                        <label for="txtPesquisaDescricao">Renda Salarial</label>
        ...
        <div id="tabs-2">
            ...
            <form id="frmCadastro" action="<?php echo $strDir;?>/controladores/RendaSalarioControlador.php" method="POST" onSubmit="return false;">
                ...
                <fieldset class="coluna">
                    ...
                    <input type="text" id="txtDescricao" name="ARS_Descricao" class="campoTextoPadrao" style="width: 250px;" placeholder="EX.: AT&Eacute; DOIS SALÁRIOS MÍNIMOS." />
                </fieldset>                
                <fieldset class="linha">
                    <input type="checkbox" id="ckbStatus" name="ARS_Status" value="I" />Inativo<br />
                </fieldset>
                <fieldset class="linha">
