...
<head>
    ...
    <script type="text/javascript" src="<?php echo $strDir; ?>/js/frmAreaAtuacao.js"></script> 
</head>

<body>    
    <div id="tabs">
        <ul>
            <li><a href="#tabs-1">Áreas de Atuação Cadastradas</a></li>
            ...
            <div>
                <form id="frmPesquisa" class="frmPesquisa">
                    <fieldset class="coluna">
                        <label for="txtPesquisaDescricao">&Aacute;rea de Atua&ccedil;&atilde;o</label>
        ...
        <div id="tabs-2">
            ...
            <form id="frmCadastro" name="frmCadastro" action="<?php echo $strDir;?>/controladores/AreaAtuacaoControlador.php" method="POST" onSubmit="return false;">
                ...
                <fieldset class="linha">
                    ...
                    <input type="text" id="txtDescricao" name="AAT_Descricao" class="campoTextoPadrao" placeholder="INFORME A DESCRIÇÃO DA ÁREA DE ATUÇÃO." style="width: 300px;"/>                
                </fieldset>                
                <fieldset class="linha">
                    <input type="checkbox" id="ckbStatus" name="AAT_Status" value="I" class="status"/>Inativo
                </fieldset>                
                <fieldset class="linha">
