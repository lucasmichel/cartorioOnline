...
<head>
    ...
    <script type="text/javascript" src="<?php echo $strDir; ?>/js/frmStatusMembro.js"></script>    
</head>
<body>    
    <div id="tabs">
        <ul>
            <li><a href="#tabs-1">Status Cadastrados</a></li>
            ...
            <div>
                <form id="frmPesquisa" onSubmit="return false;">  
                    <fieldset class="coluna">
                        <label for="txtPesquisaDescricao">Descri&ccedil;&atilde;o do Status do Membro</label>
        ...
        <div id="tabs-2">
            ...
            <form id="frmCadastro" action="<?php echo $strDir;?>/controladores/StatusMembroControlador.php" method="POST" onSubmit="return false;">
                ...
                <fieldset class="coluna">
                    ...
                    <input type="text" id="txtDescricao" name="MES_Descricao" class="campoTextoPadrao" style="width: 250px;" placeholder="DESCRI&Ccedil;&Atilde;O DO STATUS DO MEMBRO." />
                </fieldset>                
                <fieldset class="linha">
                    <input type="checkbox" id="ckbStatus" name="MES_Status" value="I" />Inativo<br />
                </fieldset>
                <fieldset class="linha">
