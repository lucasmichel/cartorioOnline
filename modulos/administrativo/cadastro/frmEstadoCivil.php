...
<head>
    ...
    <script type="text/javascript" src="<?php echo $strDir; ?>/js/frmEstadoCivil.js"></script> 
</head>

<body>    
    <div id="tabs">
        <ul>
            <li><a href="#tabs-1">Estados Civis  Cadastrados</a></li>
            ...
            <div>
                <form id="frmPesquisa" class="frmPesquisa">
                    <fieldset class="coluna">
                        <label for="txtPesquisaDescricao">Estado Civil</label>
        ...
        <div id="tabs-2">
            ...
            <form id="frmCadastro" name="frmCadastro" action="<?php echo $strDir;?>/controladores/EstadoCivilControlador.php" method="POST" onSubmit="return false;">
                ...
                <fieldset class="linha">
                    ...
                    <input type="text" id="txtDescricao" name="ECV_Descricao" class="campoTextoPadrao" placeholder="INFORME A DESCRIÇÃO DA ÁREA DE ATUÇÃO." style="width: 300px;"/>                
                </fieldset>                
                <fieldset class="linha">
                    <input type="checkbox" id="ckbConjuge" name="ECV_ExigeConjuge" value="S" class="status"/>Exige Conjuge
                </fieldset>                
                <fieldset class="linha">
                    <input type="checkbox" id="ckbStatus" name="ECV_Status" value="I" class="status"/>Inativo
                </fieldset>                
                <fieldset class="linha">
