...
<head>
    ...
    <script type="text/javascript" src="<?php echo $strDir;?>/js/frmLivroAuxiliar.js"></script>    
</head>
<body>    
    <div id="tabs">
        <ul>
            <li><a href="#tabs-1">Livros Auxiliares Cadastrados</a></li>
        ...
        <div id="tabs-2">
            ...
            <form id="frmCadastro" name="frmFormulario" action="<?php echo $strDir;?>/controladores/LivroAuxiliarControlador.php" method="POST">
                ...
                <input type="hidden" id="hddID" name="LIA_ID"/>                
                <input type="hidden" id="hddFocus"/>                
                <fieldset class="linha">                    
                    <label for="txtNumeroLivro">Nº do Livro</label>
                    <input type="text" id="txtNumeroLivro" name="LIA_NumeroLivro" class="campoTextoPadrao" style="width: 350px" placeholder="NUMERO DO LIVRO" />
                </fieldset>
