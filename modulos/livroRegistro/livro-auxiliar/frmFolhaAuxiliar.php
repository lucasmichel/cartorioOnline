...
<head>
    ...
    <script type="text/javascript" src="<?php echo $strDir;?>/js/frmFolhaAuxiliar.js"></script>    
</head>
<body>    
    <div id="tabs">
        <ul>
            <li><a href="#tabs-1">Folhas Auxiliares Cadastradas</a></li>
        ...
        <div id="tabs-2">
            ...
            <form id="frmCadastro" name="frmFormulario" action="<?php echo $strDir;?>/controladores/FolhaAuxiliarControlador.php" method="POST">
                ...
                <input type="hidden" id="hddID" name="FAU_ID"/>                
                <input type="hidden" id="hddFocus"/>  
                
                <fieldset class="linha">
                    <label for="selLivro">Livro</label>
                    <div class="side-by-side clearfix">                                                            
                    <select data-placeholder="SELECIONE O LIVRO" style="width:365px;" class="chosen-select-deselect"  id="selLivro"  name="LIA_ID">
                            <option value=""></option>
                            <?php
                                $arrStrFiltros[""] = null;                                    
                                $arrObjs = FachadaLivroAuxiliar::getInstance()->consultarLivroAuxiliar($arrStrFiltros);
                ...
                <fieldset class="linha">                    
                    ...
                    <input type="text" id="txtNumeroFolha" name="FAU_NumeroFolha" class="campoTextoPadrao" style="width: 350px" placeholder="DESCRIÇÃO" />
                </fieldset>
                
                <fieldset class="coluna">                    
                    <label for="txtData">Data</label>
                    <input type="text" id="txtData" name="FAU_DataFolha" class="campoTextoPadrao" style="width: 120px" placeholder="__/__/____" />
                </fieldset>
