...
function consultar(){ 
    ...
    if(data.sucesso == "false"){
        ...
        var params = {
            ...
            LIA_NumeroLivro: txtPesquisaNumero,
            LIA_DataHoraCadastro: txtPesquisaDataCadastro,
            limit: limitConsulta,
            offset: 0
        };
...
function initGRID(){ 
    dg.datagrid({
        ...
        ,mapper:[{
            name: 'LIA_ID', title: 'Cód.', width: 60, align: 'center'
        },{
            name: 'LIA_NumeroLivro', title: 'Numero do livro', width: 550, align: 'left'                            
        },{
            name: 'totalFolhas', title: 'Quantidade de Folhas', width: 150, align: 'left'                            
        },{            
            name: 'LIA_DataHoraCadastro', title: 'Data Cadastro', width: 100, align: 'left'        
        }/*,
