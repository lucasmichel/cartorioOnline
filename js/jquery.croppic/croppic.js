 ...
 * CROP
 * dependancy: jQuery
 * author: Ognjen "Zmaj Džedaj" Boži�?ković
 */
			...
			that.form.find('input[type="file"]').change(function(){
				...
				$.ajax({
					...
					if(response.status=='success'){						
						...
						that.obj.append('<img src="'+response.url+'" style="width: 1300px; height: 400px;">');
						that.initCropper();
			...
			$.ajax({
                ...
                type: 'POST'
					...
					if(response.status=='success'){
						...
						that.obj.append('<img class="croppedImg" src="'+response.url+'" style="width: 940px; height: 235px;">');
