...
;(function($,window,document,undefined) {
	...
	$.widget('ui.datagrid', {
		...
		,_create: function() {
			...
			// container datagrid
			this.uiDataGrid = $(_getTemplateDataGrid(this.options.pagination));
	...
	var _getTemplateDataGrid = function(pagination) {            
		var html = '<div class="ui-datagrid-container ui-widget ui-widget-content ui-corner-all">'
				...
				+'<table class="ui-datagrid">'
					+'<tbody>'
						+'<tr>';                                            
							...
							html+='<td style="visibility:hidden"><span id="spnDataGridTotal"></span></td>'
						+'</tr>'
					+'</tbody>'
				+'</table>'
			+'</div>'
